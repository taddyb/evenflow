# Obtaining the data for <experiment-name>
...
```bash
cp ../../experiments/<experiment-name>/sources.lock .ddrs/sources.lock
...
../../target/release/ddrs --workspace .ddrs \
  --config ../../experiments/<experiment-name>/arms/<arm>/ddrs.yaml \
